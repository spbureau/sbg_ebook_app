...
List<Book> popularBooks = [
  ...
  Book(
      ...
      "2008",
      "Faith & Spirituality",
      "https://m.media-amazon.com/images/I/51THV4RIGtL._SX498_BO1,204,203,200_.jpg",
      "Approach each day with joy, build positive expectations, and begin living your best life with this year of devotions designed to strengthen your faith and resolve.\n\nBestselling author Joel Osteen writes, \"When you get up in the morning, the first things you should do is set your mind in the right direction . . . and then go out anticipating good things.\" \n\nNow, for the first time, Pastor Osteen presents a tool to accomplish that goal. Based on his book, Your Best Life Now, he offers prescriptions for positive living in 365 daily messages. Each message is accompanied by a relevant scripture.",
      "https://drive.google.com/file/d/1hy6ymYxWM4yxBtAdE-_YKbv9fYlKDnSL/view?usp=drive_link",
      "Finder"),
  Book(
...
List<Book> newBooks = [
  ...
  Book(
      ...
      "Jun, 2022",
      "Humanity, Philosophy",
      "https://m.media-amazon.com/images/I/51rjhWuBsDL._AC_UY218_.jpg",
      "Designed to meet the scope and sequence of your course, Introduction to Philosophy surveys logic, metaphysics, epistemology, theories of value, and history of philosophy thematically. \n\nTo provide a strong foundation in global philosophical discourse, diverse primary sources and examples are central to the design, and the text emphasizes engaged reading, critical thinking, research, and analytical skill-building through guided activities.",
  ...
  Book(
      ...
      "2017",
      "Business, Statistics",
      //"https://m.media-amazon.com/images/I/41FnNinGKeL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg",
      "https://m.media-amazon.com/images/I/51zFwzY7sEL._AC_UY218_.jpg",
      "Introductory Business Statistics is designed to meet the scope and sequence requirements of the one-semester statistics course for business, economics, and related majors. Core statistical concepts and skills have been augmented with practical business examples, scenarios, and exercises. \n\nThe result is a meaningful understanding of the discipline, which will serve students in their business careers and real-world experiences.",
      "https://assets.openstax.org/oscms-prodcms/media/documents/IntroductoryBusinessStatistics-OP.pdf",
      "OpenStax"),
];
...
List<Book> recommendedBooks = [
  Book(
      ...
      "2021",
      "Mathematics",
      "https://m.media-amazon.com/images/I/4144FoBa4hL._SX218_BO1,204,203,200_QL40_FMwebp_.jpg",
      ...
      "OpenStax"),
  Book(
      "Organic Chemistry: A Tenth Edition from OpenStax",
      "John McMurry, Professor Emeritus",
      "2023",
      "Science, Chemistry",
      "https://m.media-amazon.com/images/I/91FIyw2qhyL._AC_UY218_.jpg",
      "John McMurry's Organic Chemistry is renowned as the most clearly written book available for organic chemistry.\nIn John McMurry's words, \"I wrote this book because I love writing. I get great pleasure and satisfaction from taking a complicated subject, turning it around until I see it clearly from a new angle, and then explaining it in simple words.\" \n\nIn Organic Chemistry: A Tenth Edition from OpenStax, McMurry continues this tradition while updating scientific discoveries, highlighting new applications, scrutinizing every piece of art, and providing example problems to assist students. Organic Chemistry: A Tenth Edition continues to meet the scope and sequence of a two-semester organic chemistry course that follows a functional group approach. \n\nA highlighted list of changes, along with a detailed table of contents and ancillary descriptions, can be found on the Instructor and Student resources sections of this page. John McMurry decided to publish Organic Chemistry: A Tenth Edition under an open license as a tribute to his son, Peter McMurry, who passed away from cystic fibrosis in December 2019. Please click here to learn more about Peter's legacy and to support the fight against cystic fibrosis.",
  ...
  Book(
      ...
      "2012",
      "Christian",
      "https://m.media-amazon.com/images/I/61DlVk1cliL._AC_UY218_.jpg",
      "God wants to bless you. He has made all of heaven’s supply available to you. But the blessings of God are not automatic. You have a part to play. To find it, you’ll need to look no further than the Holy Bible. \n\nThroughout His Word, God has indicated His desire to prosper His people. In both the Old and New Testaments, God describes His plan and purpose for prospering you— He wants to bless you abundantly, so you can be a blessing to others. \n\nThere are some who claim God doesn’t promise us physical prosperity, just spiritual. But they’re mistaken. God’s Word is full of promises about the practical kind of prosperity that gets your bills paid, buys your kids’ clothes, and helps pay your pastor’s salary. Find out the truth about God’s promises and how to tap in to heaven’s economy.\n\nDiscover that God is not keeping prosperity from you, but has provided a sure way to get it to you. Learn how to take action on His promises and become a valuable asset to the kingdom as you are Blessed to Be a Blessing!",
      "https://drive.google.com/file/d/13E23fbhhRT0rl9s9x9UZETVVIGjvmdnB/view?usp=drive_link",
      "Finder"),
  Book(
      "Honeymoon for One",
      "Chris Keniston",
  ...
  Book(
      ...
      "Amazon"),
  Book(
      "Becoming A Leader: Discover the Leader You Were Meant To Be",
      "",
      "2008",
      "Christian, Inspirational",
      "https://m.media-amazon.com/images/I/41vuJAqYfrL._SX331_BO1,204,203,200_.jpg",
      "Within each of us lies the potential to be an effective leader. Dr. Myles MunroeBecoming a Leader has been used by Fortune 500 corporations, universities, and international organizations as a tool for leadership development. \nBest-selling author Dr. Myles Munroe reveals the secrets of dynamic leadership that will turn your leadership potential into a potent reality. With the insight of Dr. Munroe, you will be able to:Become a front-runner as you overcome barriers to effective leadership.Discover natural leadership qualities lying dormant within you.Understand that true leadership means deploying others to become as good as or better than you are.Be encouraged, provoked, and stimulated as your leadership gift within is activated. True leadership is not something you grasp but something you become.",
      "https://drive.google.com/file/d/1-p6cPOuzOtxvdL2JrSLal4vRJPqbnOec/view?usp=drive_link",
      "Finder"),
  Book(
